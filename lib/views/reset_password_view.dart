...
class ResetPasswordViewState extends State<ResetPasswordView> {
  ...
  CustomAlert.showSuccessDialog(
    context: context,
    title: "Error",
    message: "No se pudo completar la solicitud. Verifica tu conexión e intenta nuevamente.",
  );
}
      ...
      body: Center(
        child: Column(
          ...
          children: [
            // Imagen SVG centrada fuera de la Card
            SvgPicture.asset(
              'assets/images/reset.svg', // Ruta de la imagen en assets
              height: 150, // Ajusta el tamaño según necesidad
            ),
            const SizedBox(height: 20), // Espacio entre la imagen y la Card
                        ...
                        style: ButtonStyle(
                          ...
                          padding: WidgetStateProperty.all(
                              const EdgeInsets.symmetric(
                                  vertical:
                                      16)), // Ajusta el padding si es necesario
                          shape: WidgetStateProperty.all(RoundedRectangleBorder(
                            borderRadius:
